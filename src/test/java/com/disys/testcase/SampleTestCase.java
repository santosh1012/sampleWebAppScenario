...
public class SampleTestCase extends BaseClass {
    ...
    @Test
    public void loginIntoApplicationWithValidScenario(){
    ...
    @Test
    public void loginIntoApplicationWithInValidScenario(){
        driver.findElement(By.id("userEmail")).sendKeys("gupta.santosh.1012@gmail.com123");
        driver.findElement(By.id("userPassword")).sendKeys("Password@123");
        driver.findElement(By.id("login")).click();
        driver.findElement(By.xpath("//button[text()=' Sign Out ']")).click();
